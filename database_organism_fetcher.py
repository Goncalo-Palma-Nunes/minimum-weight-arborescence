...
TRIPLES = [
    ...
    ("pubmlst_campylobacter_seqdef",
     "Campylobacter_jejuni_coli/in/cgMLSTv2.csv",
     "https://rest.pubmlst.org/db/pubmlst_campylobacter_seqdef/schemes/8/profiles_csv"
     ),
     ("pubmlst_campylobacter_seqdef",
     "Campylobacter_jejuni_coli/in/cgMLSTv1.csv",
     "https://rest.pubmlst.org/db/pubmlst_campylobacter_seqdef/schemes/4/profiles_csv"
     ),
    ("pubmlst_campylobacter_seqdef",
